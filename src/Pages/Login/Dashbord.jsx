    ...
    <div>
      ...
      <div className="general">
        <div className="inputField">
          <h4 style={{fontWeight:'400'}}>Explore connections, <br /> share experiences, and <br /> build your network.</h4>
          ...
          <div className="signupButton">
            <h5 
              style={{ backgroundColor: 'black', color: 'white', fontWeight:'400', }}
              onClick={handleSignUpClick} // Handle click event
            >
              Sign up with email
            </h5>
          </div>
          <p style={{fontWeight:'400'}}>By signing up, you agree to the Terms of Service and Privacy <br /> Policy, including cookie use.</p>
        </div>
